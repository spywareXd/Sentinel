    ...
    <>
      ...
      <form className="space-y-5" action={handleSubmit}>
        <div className="space-y-1.5">
          <label className="ml-1 block text-[11px] font-bold uppercase tracking-widest text-[var(--on-surface-variant)]">
            Email or Username
          </label>
          <input
            type="text"
            ...
            required
            className="w-full rounded-xl border border-outline-variant/20 bg-white px-4 py-3.5 text-[15px] text-[#05070a] transition-all placeholder:text-[#05070a]/40 focus:border-[#a3a5fa] focus:outline-none focus:ring-1 focus:ring-[#a3a5fa]"
          />
        </div>

        <div className="space-y-1.5">
          <div className="ml-1 flex items-center justify-between pr-1">
            <label className="block text-[11px] font-bold uppercase tracking-widest text-[var(--on-surface-variant)]">
              Password
            </label>
          ...
          <input
            ...
            placeholder="********"
            required
            className="w-full rounded-xl border border-outline-variant/20 bg-white px-4 py-3.5 text-sm tracking-widest text-[#05070a] transition-all placeholder:text-[#05070a]/40 focus:border-[#a3a5fa] focus:outline-none focus:ring-1 focus:ring-[#a3a5fa]"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-8 w-full rounded-xl bg-[#a3a5fa] py-3.5 text-[15px] font-bold text-[#0a0c14] shadow-[0_0_20px_rgba(163,165,250,0.15)] transition-all hover:bg-[#b5b7fa] hover:shadow-[0_0_25px_rgba(163,165,250,0.3)] disabled:opacity-70"
        >
...
export default function Login() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background p-4 font-body text-on-surface">
      <div className="pointer-events-none absolute left-0 top-0 -z-10 flex h-full w-full items-center justify-center overflow-hidden">
        <div className="absolute h-[150%] w-[150%] bg-[radial-gradient(circle_at_center,rgba(163,165,250,0.06)_0%,rgba(5,7,10,0)_60%)]" />
      </div>

      <div className="relative z-10 my-10 flex w-full max-w-md flex-col items-center">
        ...
        <div className="w-full rounded-3xl border border-white/[0.02] bg-surface-container/90 p-8 shadow-2xl backdrop-blur-md">
          <div className="mb-8 text-center">
            <h2 className="mb-2 font-headline text-[26px] font-bold">Welcome back</h2>
